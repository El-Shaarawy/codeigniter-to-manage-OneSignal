...
<div class="starter-template">
            ...
            <div class="contact-form">
                ...
                <form id="ServiceRequest" action="<?php echo base_url('quotes/sendMessage_tags'); ?>" method='post'>
					...
					<div class="form-group">
                        <label class="control-label">Message Body:</label>
												...
												<input type="hidden" name="user_id" class="form-control" readonly value="<?php echo $user_id;?>" >
												<input type="hidden" name="email" class="form-control" readonly value="<?php echo $email;?>" >
                    </div>
